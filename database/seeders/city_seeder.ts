...
export default class extends BaseSeeder {
  ...
  async run() {
    ...
    let i = 0
    try {
      const fileContent = await readFile('./database/seeders/json/countries.json', 'utf-8')
    ...
    try {
      i = 0
      const fileContent = await readFile('./database/seeders/json/states.json', 'utf-8')
    ...
    try {
      const fileContent = await readFile('./database/seeders/json/cities.json', 'utf-8')
